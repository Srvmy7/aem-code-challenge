...
@ObjectClassDefinition(
        name = "my demo - JSON Creator Scheduler Configuration",
...
public @interface JSONCreatorConfig {
    ...
    public String schedulerName() default "myDemo_JSON_Creator";
    ...
    public String getSiteParent() default "/content/mydemo";
}
