package com.example.aem.demo.core.constants;
...
public final class Constants {
    ...
    public static final String ADDAUTHOR_SELECTORS=  "adduser";
    public final static String ADDAUTHOR_RESOURCE_TYPE="mydemo/components/custom/adduser";
